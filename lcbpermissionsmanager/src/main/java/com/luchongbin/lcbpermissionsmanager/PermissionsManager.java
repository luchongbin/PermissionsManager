...
class PermissionsManager {
    ...
    private PermissionsService mService;
    private LCBCPOptions mOptions;
    private LCBCPListener mCallback;
    ...
    PermissionsManager(Context context) {
        mContext = context;
        mService = new PermissionsService();
     ...
     * @param acpListener
     */
    synchronized void request(LCBCPOptions options, LCBCPListener acpListener) {
    ...
    private synchronized void startAcpActivity() {
        Intent intent = new Intent(mContext, LCBCPActivity.class);
...
//    }
    ...
    private void startSetting() {
        if (MiuiUnits.isMIUI()) {
            Intent intent = MiuiUnits.getSettingIntent(mActivity);
            if (MiuiUnits.isIntentAvailable(mActivity, intent)) {
